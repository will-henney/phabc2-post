...
gright.pyxplotcontour(data['xn'], (worldwidth/nx)*(xx+0.5), (worldheight/ny)*(yy+0.5),
		 ...
		 lw=2,
		 lineattrs=[pyx.color.transparency(0.2), pyx.style.linestyle.dashed]
		 )
...
velarrowfunc = pyx.graph.data.paramfunction(
...
gleft.plot(velarrowfunc, [pyx.graph.style.arrow(arrowsize=0.15,
