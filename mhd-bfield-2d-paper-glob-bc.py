...
Version 0.4: WJH 19 Apr 2009 - additional logic for the different BCs
...
# Boundary conditions
bcdict = {
    'm' : r'Outflow boundary conditions', 
    'p' : r'Periodic boundaries in \(y\)', 
    'r' : r'Reflection boundary at \(x = 0\)', 
    's' : r'Semi-permeable boundaries in \(y\)', 
    }
# Look at last letter of runid
bcstring = bcdict[runid[-1]]
...
#     return min(v[jj,ii], 1.0)
#     if imagedata[-jj,ii] > 1.5:
# 	return v[jj,ii]
#     else:
# 	return 0.0
...
# WJH 20 Apr 2009 - change to showing BC type
textmargin = 12*pyx.unit.x_pt
textalignment = [pyx.text.halign.right, pyx.text.valign.bottom] 
gright.text(figwidth - textmargin, textmargin, bcstring, textalignment)
